...
<html lang="fr">
	...
	<body>
	    ...
	    $login = utf8_decode($_POST['zoneLogin']);
	    $NomLog = utf8_decode($_POST['zoneNomLog']);
	    $PrenomLog = utf8_decode($_POST['zonePrenomLog']);
		...
		<div>
                    <label for = "zoneNomLog">Nom : </label>
                    <input type="text" id="zoneNomLog" name="zoneNomLog" 				placeholder="Entrez votre nom" required>
                </div>
		<div>
                    <label for = "zonePrenomLog">Prenom : </label>
                    <input type="text" id="zonePrenomLog" name="zonePrenomLog" 				placeholder="Entrez votre prenom" required>
                </div>
                <div>
